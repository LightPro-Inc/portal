...
(function (app) {
    ...
    logCtrl.$inject = ['$state', '$timeout', 'apiService', 'notificationService', 'utilityService', 'contactService', '$uibModal'];
    function logCtrl($state, $timeout, apiService, notificationService, utilityService, contactService, $uibModal) {
        var vm = this;
        ...
        function search(page) {
            ...
            vm.loadingData = true;
			apiService.get('/web/api/log/search', config, 
					function(result){					
        ...
        vm.$onInit = function () {
            ...
            apiService.get('/web/api/module/installed', {}, function(response){
