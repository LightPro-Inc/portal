(function(app){
    ...
    app.directive('salesResumePdvIndicator', salesResumePdvIndicator);

    salesResumePdvIndicator.$inject = ['$uibModal', 'apiService', '$q', 'notificationService', '$rootScope']; 
    function salesResumePdvIndicator($uibModal, apiService, $q, notificationService, $rootScope) {
        return {
            restrict: 'EA',
            templateUrl: "modules/pdv/dashboard/indicators/sales-resume/salesResumeView.html",
        					        ...
        					        function (response) {		        					
        			                    ...
        			                    scope.salesByPdv = {
        			                        chart: {
        			                            ...
        			                            plottooltext: "Point de vente : $label / Montant : $datavalue " + $rootScope.companyCurrency.symbol,
        			                            theme: "fint"
        			                        },
        			                        data: data
        			                    };
