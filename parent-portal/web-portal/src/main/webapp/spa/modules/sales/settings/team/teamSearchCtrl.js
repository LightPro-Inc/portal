(function(app){
	...
	app.controller('teamSearchCtrl', teamSearchCtrl);
	
	teamSearchCtrl.$inject = ['data', 'apiService', '$uibModalInstance'];
	function teamSearchCtrl(data, apiService, $uibModalInstance){
		var vm = this;
